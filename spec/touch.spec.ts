...
let tEvents: { tapEvent: Function, doubleTapEvent: Function, tapHold: Function, swipe: Function, scroll: Function } = {
    tapEvent: (): void => { /** Do Nothing */ },
    doubleTapEvent: (): void => { /** Do Nothing */ },
...
//Async Test For Double Tap Event // DoubleTap delay is 500ms
function DoubleTapEventTest(done: Function): void {
    touchTestObj.startEvent(startMouseEventArs);
    touchTestObj.endEvent(endMouseEventArs);
    touchTestObj.startEvent(startMouseEventArs);
    touchTestObj.endEvent(endMouseEventArs);
...
touchTestObj.doubleTap = () => { tEvents.doubleTapEvent(); };
...
describe('Touch', () => {
    ...
    describe('Initialization of touch', () => {
        ...
        it('constructor with options', () => {
            let ele: HTMLElement = createElement('div', { id: 'test' });
            let objTouch: Touch = new Touch(ele, { doubleTap: (): void => {/** test */ } });
    ...
    describe('Doubletap event handler', () => {
        let doubleTapFn: jasmine.Spy = jasmine.createSpy('doubleTap');
        ...
        it('doubletap event callback with event handler', () => {
            expect(doubleTapFn).toHaveBeenCalled();
        });
    });

    describe('Doubletap event', () => {
        beforeEach((done: Function): void => {
            touchTestObj.doubleTap = () => { tEvents.doubleTapEvent(); };
            DoubleTapEventTest(done);
        });

        it('doubletap event callback.', () => {
